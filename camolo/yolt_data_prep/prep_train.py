...
# run in docker container (see setup.txt)
...
def main():    
    ...
    # output dirs
    out_dir_root = '/wdata'
    # out_dir_root = os.path.join(data_dir, 'data_yolov4_2')
    # make dirs
    ...
    for im_dir_tmp in [
        ...
        # for yolov4, labels need to be in the same folder as images for training, 
        # so copy over
